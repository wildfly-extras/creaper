...
public class AddConnectionFactoryToRAOnlineTest {
    ...
    @Test
    public void addConnectionFactoryTestcase() throws Exception {
        client.apply(new AddResourceAdapter.Builder(RA_ID, "org.jboss.genericjms", TransactionType.NONE).build());
        admin.reloadIfRequired();
        client.apply(new AddConnectionFactoryToRA.Builder("cf1", "java:/jms/myRAConnectionFactory", RA_ID).build());
        admin.reloadIfRequired();
    ...
    public void addConnectionFactoryNegativeTestcase() throws Exception {
        client.apply(new AddResourceAdapter.Builder(RA_ID, "org.jboss.genericjms", TransactionType.NONE).build());
        admin.reloadIfRequired();
        client.apply(new AddConnectionFactoryToRA.Builder("cf1", "java:/jms/myRAConnectionFactory", "invalidRAId")
                .build());
    }
}
