...
public class AddAdminObjectToRAOnlineTest {
    ...
    @Test
    public void addAdminObjectTestcase() throws Exception {
        ...
        client.apply(new AddAdminObjectToRA.Builder("q1", "q1", RA_ID)
                .addProperty("prp", "prop").setClassName("com.someClassName").setUseJavaContext(true).build());
        admin.reloadIfRequired();
    ...
    public void addAdminObjectNegativeTestcase() throws Exception {
        client.apply(new AddResourceAdapter.Builder(RA_ID, "org.jboss.genericjms", TransactionType.NONE).build());
        admin.reloadIfRequired();
        client.apply(new AddAdminObjectToRA.Builder("q1", "q1", "invalidRAId")
                .addProperty("prp", "prop").setClassName("com.someClassName").setUseJavaContext(true).build());
    }
