...
public class ChangePeriodicHandlerOfflineTest {
    ...
    public void addAll() throws Exception {
        ...
        ChangePeriodicRotatingFileLogHandler changePeriodicHandler = Logging.handler().periodicRotatingFile()
                .change("handler", "server.log", ".suffix")
    ...
    public void nonExisting() throws Exception {
        ...
        ChangePeriodicRotatingFileLogHandler changePeriodicHandler = Logging.handler().periodicRotatingFile()
                .change("Noexisting", "server.log", ".suffix")
                .filter("match(\"filter*\")")
                .encoding(Charsets.UTF_8)
                .build();
