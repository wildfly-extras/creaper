...
public class ChangeLoggerOnlineTest {
    ...
    public void changeEverything() throws Exception {
        ...
        assertEquals("level should be changed", LogLevel.DEBUG.value(), result.stringValue());
    ...
    public void changeNothing() throws Exception {
        ...
        ModelNodeResult result = ops.readAttribute(TEST_LOGGER_ADDRESS, "level");
        result.assertSuccess();
        assertEquals("level should not be changed", LogLevel.DEBUG.value(), result.stringValue());
