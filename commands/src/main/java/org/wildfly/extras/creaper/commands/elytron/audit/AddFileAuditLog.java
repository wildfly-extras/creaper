...
public final class AddFileAuditLog implements OnlineCommand {
    ...
    private AddFileAuditLog(Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder(String name) {
            if (name == null) {
                throw new IllegalArgumentException("Name of the file-audit-log must be specified as non null value");
            }
            if (name.isEmpty()) {
                throw new IllegalArgumentException("Name of the file-audit-log must not be empty value");
            }
            this.name = name;
        }
